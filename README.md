...
本项目flutter版本最早使用1.17版本，现已升级到最新3.27版本并进行重大改版。本项项目主要是对常见彩种如福彩3D、排列三、双色球、大乐透以及七乐彩五种彩票的预测、开奖、号码走势等等，
主要功能有预测、开奖、预警分析、选号走势、支付会员、签到、积分、广告以及会员抽奖等丰富功能。

本项目主要对andriod端实现，ios需做一定适配也可实现，有更多想法需求请联系我(Telegram @jpchou  订阅频道https://t.me/prize_lottery_app 一起交流探讨)。

...
import 'package:lottery_app/model/pl3_bigshot.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class Pl3BigshotPage extends StatefulWidget {
  @override
  Pl3BigshotPageState createState() => new Pl3BigshotPageState();
}
...
class Pl3BigshotPageState extends State<Pl3BigshotPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => Pl3BigshotModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('大神统计'),
  ...
  Widget _buildTitle() {
    return Consumer(
      builder: (BuildContext context, Pl3BigshotModel model, Widget child) {
        return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(
                  model.period != null ? '第${model.period}期排列三牛人统计' : '',
                  style: TextStyle(

...
import 'package:lottery_app/model/fc3d_bigshot.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class Fc3dBigshotPage extends StatefulWidget {
  @override
  Fc3dBigshotPageState createState() => new Fc3dBigshotPageState();
}
...
class Fc3dBigshotPageState extends State<Fc3dBigshotPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<Fc3dBigshotModel>(
        create: (_) => Fc3dBigshotModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('大神统计'),
  ...
  Widget _buildTitle() {
    return Consumer(
        builder: (BuildContext context, Fc3dBigshotModel model, Widget child) {
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                model.period != null ? '第${model.period}期福彩3D牛人统计' : '',
                style: TextStyle(
  ...
  Widget _buildHelpInfo() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1.臻选牛人说明：将平台专家预测命中率高的专家臻选出来，进行统计分析。',
            style: TextStyle(
          ...
          Text(
            '2.热门统计分析是将收费专家预测数据按独胆、双胆、三胆、五码、六码、七码、杀一码、杀二码指标进行的统计分析。',
            style: TextStyle(
              fontSize: Adaptor.sp(12),
              color: Colors.black38,
            ),
          ...
          Text(
            '3.关于臻选牛人统计指标，需要您在使用过程中多观察、多总结，相信一定能为您带来意想不到的收获。',
            style: TextStyle(
              fontSize: Adaptor.sp(12),
              color: Colors.black38,
            ),

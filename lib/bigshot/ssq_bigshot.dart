...
import 'package:lottery_app/model/ssq_bigshot.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class SsqBigshotPage extends StatefulWidget {
  @override
  SsqBigshotPageState createState() => new SsqBigshotPageState();
}
...
class SsqBigshotPageState extends State<SsqBigshotPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => SsqBigshotModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('牛人臻选'),
  ...
  Widget _buildTitle() {
    return Consumer(
        builder: (BuildContext context, SsqBigshotModel model, Widget child) {
      return Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                model.period != null ? '第${model.period}期双色球牛人统计' : '',
                style: TextStyle(
  ...
  Widget _buildHelpInfo() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Text(
            '1.双色球牛人专家说明：平台认为预测命中率最高的一部分专家，认为这部分具有丰富的经验的专家为牛人。',
            style: TextStyle(

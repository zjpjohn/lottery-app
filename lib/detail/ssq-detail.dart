...
import 'package:lottery_app/model/ssq_detail.dart';
import 'package:provider/provider.dart';

class SsqDetailPage extends StatefulWidget {
  String masterId;

  SsqDetailPage({@required this.masterId});

  @override
  SsqDetailPageState createState() => new SsqDetailPageState();
}

class SsqDetailPageState extends State<SsqDetailPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => SsqDetailModel.initialize(masterId: widget.masterId),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('最新预测'),
  ...
  Widget _buildTitle(SsqDetailModel model) {
    return Container(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, SsqDetailModel model, Widget child) {

...
import 'package:lottery_app/model/fc3d_detail.dart';
import 'package:provider/provider.dart';

class Fc3dDetailPage extends StatefulWidget {
  String masterId;

  Fc3dDetailPage({@required this.masterId});

  @override
  Fc3dDetailPageState createState() => new Fc3dDetailPageState();
}

class Fc3dDetailPageState extends State<Fc3dDetailPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => Fc3dDetailModel.initialize(masterId: widget.masterId),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('最新预测'),
  ...
  Widget _buildTitle(Fc3dDetailModel model) {
    return Container(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, Fc3dDetailModel model, Widget child) {

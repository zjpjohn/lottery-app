...
import 'package:lottery_app/model/dlt_history_detail.dart';
import 'package:provider/provider.dart';

class DltHistoryDetailPage extends StatelessWidget {
  String masterId;

  DltHistoryDetailPage({@required this.masterId});

  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<DltHistoryDetailModel>(
        create: (_) => DltHistoryDetailModel.initialize(masterId: masterId),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('上期历史'),
  ...
  Widget _buildHistoryView() {
    return Consumer(builder:
        (BuildContext context, DltHistoryDetailModel model, Widget child) {
  ...
  Widget _buildTitle(DltHistoryDetailModel model) {
    return Container(

...
import 'package:lottery_app/model/fc3d_overall.dart';
...
class Fc3dOverallPage extends StatefulWidget {
  @override
  Fc3dOverallPageState createState() => new Fc3dOverallPageState();
}
...
class Fc3dOverallPageState extends State<Fc3dOverallPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<Fc3dOverallModel>(
        create: (_) => Fc3dOverallModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('整体态势'),
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, Fc3dOverallModel model, Widget child) {
      return Container(
        child: Column(
          children: <Widget>[
            _buildTitle(model),
  ...
  Widget _buildTitle(Fc3dOverallModel model) {
    String title = '';
    if (model.period != null) {
      title = '第${model.period}期福彩3D整体态势';
    }
    return Container(
  ...
  Widget _buildGridTab(Fc3dOverallModel model) {
    return Padding(

...
import 'package:lottery_app/list/fc3d-list.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/commons/app_navigator.dart';
import 'package:lottery_app/master/fc3d-master.dart';
import 'package:lottery_app/components/adaptor.dart';

class Fc3dForecastPage extends StatefulWidget {
  @override
  Fc3dForecastPageState createState() => new Fc3dForecastPageState();
}

class Fc3dForecastPageState extends State<Fc3dForecastPage>
  ...
  //组合五专家
  List _com5s = new List();

  //组合六专家
  List _com6s = new List();

  //组合七专家
  List _com7s = new List();

  //杀一码专家
  List _kill1s = new List();

  //杀二码专家
  List _kill2s = new List();

  //定位专家
  List _comb5s = new List();
  ...
  List<Widget> _itemsWidget(
    ...
    views.add(
      Container(
        ...
        padding:
            EdgeInsets.fromLTRB(Adaptor.width(16), 0, Adaptor.width(16), 0),
        child: Row(
          ...
          children: <Widget>[
            ...
            GestureDetector(
              onTap: () {
                AppNavigator.push(context, Fc3dListPage(index, title),
                    login: true);
              },
              child: Container(
  ...
  Widget _itemView(BuildContext context, int index) {
    ...
    if (index + 1 == 4) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('组合五码', 4, _com5s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 5) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('组合六码', 5, _com6s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 6) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('组合七码', 6, _com7s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 7) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('杀一码', 7, _kill1s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 8) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('杀二码', 8, _kill2s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 9) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('定位五码', 9, _comb5s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
  ...
  void _loadData() {
    ...
    request.getJson('/hmaster/fc3d').then((response) {

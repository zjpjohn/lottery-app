...
import 'package:lottery_app/list/dlt-list.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/commons/app_navigator.dart';
import 'package:lottery_app/master/dlt-master.dart';
import 'package:lottery_app/components/adaptor.dart';

class DltForecastPage extends StatefulWidget {
  @override
  DltForecastPageState createState() => new DltForecastPageState();
}

class DltForecastPageState extends State<DltForecastPage>
  ...
  //蓝球二码专家
  List _blue2s = new List();

//蓝球六码专家
  List _blue6s = new List();
...
//蓝球杀码专家
    ...
    views.add(new Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          GestureDetector(
            onTap: () {
              AppNavigator.push(context, DltListPage(index, title),
                  login: true);
            },
            child: Container(
  ...
  Widget _itemView(BuildContext context, int index) {
    ...
    if (index + 1 == 4) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('红球10码', 4, _red10s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 6) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('杀三码', 6, _kill3s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 7) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('杀六码', 7, _kill6s, [
            Color(0xeFFFF4600),
            Color(0xeFFFF4600),
          ]),
        ),
    ...
    if (index + 1 == 8) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('蓝球二码', 8, _blue2s, [
            Color(0xeFF3376F6),
            Color(0xeFF3376F6),
          ]),
        ),
    ...
    if (index + 1 == 9) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('蓝球六码', 9, _blue6s, [
            Color(0xeFF3376F6),
            Color(0xeFF3376F6),
          ]),
        ),
    ...
    if (index + 1 == 10) {
      return new Container(
        width: double.infinity,
        child: Column(
          children: _itemsWidget('蓝球杀码', 10, _bkills, [
            Color(0xeFF3376F6),
            Color(0xeFF3376F6),
          ]),
        ),
  ...
  void _loadData() {
    ...
    request.getJson('/hmaster/dlt').then((response) {

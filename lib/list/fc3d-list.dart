...
import 'package:lottery_app/list/items/fc3d-high-list.dart';
import 'package:lottery_app/list/items/fc3d-low-list.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/components/adaptor.dart';

class Fc3dListPage extends StatefulWidget {
  int _type;

  String _name;

  Fc3dListPage(this._type, this._name);

  @override
  Fc3dListPageState createState() => new Fc3dListPageState();
}

class Fc3dListPageState extends State<Fc3dListPage>
  ...
  void initState() {
    super.initState();
    _views = <Widget>[Fc3dHighList(widget._type), Fc3dLowList(widget._type)];
    _tabController =

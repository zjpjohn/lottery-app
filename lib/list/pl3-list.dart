...
import 'package:lottery_app/list/items/pl3-high-list.dart';
import 'package:lottery_app/list/items/pl3-low-list.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/components/adaptor.dart';

class Pl3ListPage extends StatefulWidget {
  int _type;

  String _name;

  Pl3ListPage(this._type, this._name);

  @override
  Pl3ListPageState createState() => new Pl3ListPageState();
}

class Pl3ListPageState extends State<Pl3ListPage>
  ...
  void initState() {
    super.initState();
    _views = <Widget>[
      Pl3HighList(widget._type),
      Pl3LowList(widget._type),
    ];
    _tabController =

...
import 'package:lottery_app/list/items/qlc-high-list.dart';
import 'package:lottery_app/list/items/qlc-low-list.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/components/adaptor.dart';

class QlcListPage extends StatefulWidget {
  int _type;

  String _name;

  QlcListPage(this._type, this._name);

  @override
  QlcListPageState createState() => new QlcListPageState();
}

class QlcListPageState extends State<QlcListPage> {
  //tab选项
      ...
      child: Row(
        children: <Widget>[
          Text(
            '七乐彩',
            style:
                TextStyle(color: Color(0xff7c7c7c), fontSize: Adaptor.sp(14)),
          ),
          Icon(
  ...
  void initState() {
    super.initState();
    _views = <Widget>[QlcHighList(widget._type), QlcLowList(widget._type)];
    _tabController =

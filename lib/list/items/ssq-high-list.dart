...
class SsqHighList extends StatefulWidget {
  int _type;

  SsqHighList(this._type);

  @override
  SsqHighListState createState() => new SsqHighListState();
}

class SsqHighListState extends State<SsqHighList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/ssq/vip/ranks', params: params).then((response) {

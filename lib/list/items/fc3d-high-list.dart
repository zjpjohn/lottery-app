...
class Fc3dHighList extends StatefulWidget {
  int _type;

  Fc3dHighList(this._type);

  @override
  Fc3dHighListState createState() => new Fc3dHighListState();
}

class Fc3dHighListState extends State<Fc3dHighList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/fc3d/vip/ranks', params: params).then((response) {

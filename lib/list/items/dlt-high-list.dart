...
class DltHighList extends StatefulWidget {
  int _type;

  DltHighList(this._type);

  @override
  DltHighListState createState() => new DltHighListState();
}

class DltHighListState extends State<DltHighList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/dlt/vip/ranks', params: params).then((response) {

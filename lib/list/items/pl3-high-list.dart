...
class Pl3HighList extends StatefulWidget {
  int _type;

  Pl3HighList(this._type);

  @override
  Pl3HighListState createState() => new Pl3HighListState();
}

class Pl3HighListState extends State<Pl3HighList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/pl3/vip/ranks', params: params).then((response) {

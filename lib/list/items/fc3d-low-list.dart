...
class Fc3dLowList extends StatefulWidget {
  int _type;

  Fc3dLowList(this._type);

  @override
  Fc3dLowListState createState() => new Fc3dLowListState();
}

class Fc3dLowListState extends State<Fc3dLowList>
  ...
  void _loadData() {
    ...
    request.getJson('/fc3d/free/ranks', params: params).then((response) {

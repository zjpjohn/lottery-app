...
class SsqLowList extends StatefulWidget {
  int _type;

  SsqLowList(this._type);

  @override
  SsqLowListState createState() => new SsqLowListState();
}

class SsqLowListState extends State<SsqLowList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/ssq/free/ranks', params: params).then((response) {

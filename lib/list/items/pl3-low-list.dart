...
class Pl3LowList extends StatefulWidget {
  int _type;

  Pl3LowList(this._type);

  @override
  Pl3LowListState createState() => new Pl3LowListState();
}

class Pl3LowListState extends State<Pl3LowList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/pl3/free/ranks', params: params).then((response) {

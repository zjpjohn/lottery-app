...
class QlcHighList extends StatefulWidget {
  int _type;

  QlcHighList(this._type);

  @override
  QlcHighListState createState() => new QlcHighListState();
}

class QlcHighListState extends State<QlcHighList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/qlc/vip/ranks', params: params).then((response) {

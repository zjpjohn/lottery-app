...
class QlcLowList extends StatefulWidget {
  int _type;

  QlcLowList(this._type);

  @override
  QlcLowListState createState() => new QlcLowListState();
}

class QlcLowListState extends State<QlcLowList>
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/qlc/free/ranks', params: params).then((response) {

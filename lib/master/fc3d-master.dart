...
import 'package:lottery_app/detail/fc3d_history_detail.dart';
import 'package:lottery_app/master/model/item-model.dart';
import 'package:lottery_app/commons/tools.dart';
import 'package:lottery_app/detail/fc3d-detail.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/commons/app_navigator.dart';
import 'package:lottery_app/master/widgets/fc3d_achieve_widget.dart';
import 'package:lottery_app/components/adaptor.dart';
import 'package:lottery_app/model/fc3d_master.dart';
import 'package:lottery_app/model/global_config.dart';
import 'package:provider/provider.dart';

class Fc3dMasterPage extends StatefulWidget {
  String _masterId;

  final int index;

  Fc3dMasterPage(this._masterId, {this.index: 1});

  @override
  Fc3dMasterPageState createState() => new Fc3dMasterPageState();
}

class Fc3dMasterPageState extends State<Fc3dMasterPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: ChangeNotifierProvider<Fc3dMasterModel>(
        create: (_) => Fc3dMasterModel.initialize(masterId: widget._masterId),
        child: Scaffold(
          body: Container(
  ...
  Widget _buildContent() {
    return Consumer2<GlobalConfigModel, Fc3dMasterModel>(builder: (
      BuildContext context,
      GlobalConfigModel config,
      Fc3dMasterModel model,
      Widget child,
    ) {
            ...
            child: Column(
              children: <Widget>[
                if (model.detail.vip == 1)
                  IssueNotice(
                    notice:
                        '查看预测需${config.config.fc3dFee}金币，最多使用代金券抵扣${config.config.fc3dVoucher}金币',
                  ),
  ...
  ///创建专家信息组件
  Widget _buildMaster(Fc3dMasterDetail detail) {
    return Container(
      color: Colors.white,
      child: Column(
        children: <Widget>[
    ...
    return new Container(
      ...
      child: Row(
        children: <Widget>[
          Text(
            name,
            style: TextStyle(color: Colors.black54, fontSize: Adaptor.sp(13)),
          ),
          Text(
            hit,
            style:
                TextStyle(color: Color(0xFFFF512F), fontSize: Adaptor.sp(13)),
          )
        ],
      ),
    );
  ...
  Widget _buildHistory(Fc3dHistory history) {
  ...
  List<Widget> _buildTabPage(Fc3dHistory history) {
    return <Widget>[
    ...
    if (data.length > 0) {
      return Container(
        ...
        child: ListView.builder(
            padding: EdgeInsets.fromLTRB(0, 0, 0, Adaptor.width(15)),
  ...
  Widget _buildItem(List<ItemVo> data, int index, {bool showHit: false}) {
    ...
    return Container(
      child: Column(
        children: <Widget>[
          Container(
            padding: EdgeInsets.fromLTRB(Adaptor.width(12), Adaptor.width(4),
                Adaptor.width(12), Adaptor.width(2)),
            child: Row(
          ...
          Container(
            padding: EdgeInsets.fromLTRB(
                Adaptor.width(12), 0, Adaptor.width(12), Adaptor.width(6)),
            child: Row(

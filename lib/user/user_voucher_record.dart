...
import 'package:lottery_app/model/voucher_record.dart';
import 'package:provider/provider.dart';

class VoucherRecordPage extends StatefulWidget {
  @override
  VoucherRecordPageState createState() => new VoucherRecordPageState();
}

class VoucherRecordPageState extends State<VoucherRecordPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: ChangeNotifierProvider<VoucherRecordModel>(
        create: (_) => VoucherRecordModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              NavAppBar(
  ...
  Widget _buildContentView() {
    return Consumer(builder:
        (BuildContext context, VoucherRecordModel model, Widget child) {
  ...
  Widget _buildRecordItem(VoucherRecord record) {
    return Container(

...
class SsqBigshotModel with ChangeNotifier {
  ...
  void loadData() {
    ...
    request.getJson('/ssq/rate/census').then((response) {
      ...
      putData(5, _parseData(json.decode(data['red25'])));
      putData(6, _parseData(json.decode(data['kill3'])));
      putData(7, _parseData(json.decode(data['kill6'])));
      putData(8, _parseData(json.decode(data['blue3'])));
      putData(9, _parseData(json.decode(data['blue5'])));

...
class Fc3dPredictDetailModel with ChangeNotifier {
  String _period;

  Fc3dForecast _forecast;

  LoadState _state = LoadState.loading;

  Fc3dPredictDetailModel.initialize({@required String period}) {
    _period = period;
    queryForecast();
  }
  ...
  void queryForecast() {
    ...
    request
        .getJson('/expert/fc3d/forecast', params: Map()..['period'] = period)
        .then((response) {
  ...
  Fc3dForecast get forecast => _forecast;

  set forecast(Fc3dForecast value) {
    _forecast = value;
    notifyListeners();
  }

...
class Fc3dRanksPage extends StatefulWidget {
  @override
  Fc3dRanksPageState createState() => new Fc3dRanksPageState();
}

class Fc3dRanksPageState extends State<Fc3dRanksPage> {
  //是否加载完成
  bool _loaded = false;
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/fc3d/top/masters', params: params).then((response) {

...
import 'package:lottery_app/shrink/dialog/ssq_lottery_view.dart';
import 'package:lottery_app/shrink/model/ssq_shrink_filter.dart';
...
class SsqShrinkPage extends StatefulWidget {
  @override
  SsqShrinkPageState createState() => new SsqShrinkPageState();
}

class SsqShrinkPageState extends State<SsqShrinkPage> {
  ///缩水过滤器
  SsqShrinkFilter filter = SsqShrinkFilter();

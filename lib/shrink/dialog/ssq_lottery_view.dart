...
class SsqLotteryView extends StatefulWidget {
  SsqShrinkFilter filter;

  SsqLotteryView({this.filter});

  @override
  SsqLotteryViewState createState() => new SsqLotteryViewState();
}

class SsqLotteryViewState extends State<SsqLotteryView> {
  bool loading = true;

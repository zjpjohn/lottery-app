...
import 'package:lottery_app/model/pl3_chart.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class Pl3ComprehensivePage extends StatefulWidget {
  @override
  Pl3ComprehensivePageState createState() => new Pl3ComprehensivePageState();
}
...
class Pl3ComprehensivePageState extends State<Pl3ComprehensivePage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<Pl3ChartModel>(
        create: (_) => Pl3ChartModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('综合统计'),
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, Pl3ChartModel model, Widget child) {
      return Container(
        child: Column(
          children: <Widget>[
            _buildTitle(model),
  ...
  Widget _buildTitle(Pl3ChartModel model) {
    String title = '';
    if (model.period != null) {
      title = '第${model.period}期排列三综合统计';
    }
    return Container(
  ...
  Widget _buildGridTab(Pl3ChartModel model) {
    return Padding(
      padding: EdgeInsets.only(

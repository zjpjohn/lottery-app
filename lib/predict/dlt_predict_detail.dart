...
import 'package:lottery_app/model/dlt_predict_detail.dart';
import 'package:provider/provider.dart';

class DltPredictDetail extends StatefulWidget {
  String period;

  DltPredictDetail({@required this.period});

  @override
  DltPredictDetailState createState() => new DltPredictDetailState();
}

class DltPredictDetailState extends State<DltPredictDetail> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<DltPredictDetailModel>(
        create: (_) => DltPredictDetailModel.initialize(period: widget.period),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('预测详情'),
  ...
  Widget _buildForecast() {
    return Consumer<DltPredictDetailModel>(builder:
        (BuildContext context, DltPredictDetailModel model, Widget child) {
        ...
        return Expanded(
          child: ListView(
            ...
            children: <Widget>[
              ...
              _buildItem('红球10码', model.forecast.opened, model.forecast.red10),
              _buildItem('红球20码', model.forecast.opened, model.forecast.red20),
              ...
              _buildItem('蓝球杀码', model.forecast.opened, model.forecast.bkill),
              _buildItem('蓝球六码', model.forecast.opened, model.forecast.blue6),
              _buildItem('蓝球双胆', model.forecast.opened, model.forecast.blue2),
              _buildItem('蓝球独胆', model.forecast.opened, model.forecast.blue1),
              ForecastNotice(),
            ],
          ),
        );
  ...
  Widget _buildTitle(DltPredictDetailModel model) {
    return Container(

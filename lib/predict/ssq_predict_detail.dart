...
import 'package:lottery_app/model/ssq_predict_detail.dart';
import 'package:provider/provider.dart';

class SsqPredictDetail extends StatefulWidget {
  String period;

  SsqPredictDetail({@required this.period});

  @override
  SsqPredictDetailState createState() => new SsqPredictDetailState();
}

class SsqPredictDetailState extends State<SsqPredictDetail> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider<SsqPredictDetailModel>(
        create: (_) => SsqPredictDetailModel.initialize(period: widget.period),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('预测详情'),
  ...
  Widget _buildForecast() {
    return Consumer<SsqPredictDetailModel>(builder:
        (BuildContext context, SsqPredictDetailModel model, Widget child) {
        ...
        return Expanded(
          child: ListView(
            ...
            children: <Widget>[
              ...
              _buildItem('红球25码', model.forecast.opened, model.forecast.red25),
              ...
              _buildItem('蓝球五码', model.forecast.opened, model.forecast.blue5),
              _buildItem('蓝球三胆', model.forecast.opened, model.forecast.blue3),
              ForecastNotice(),
            ],
          ),
        );
  ...
  Widget _buildTitle(SsqPredictDetailModel model) {
    return Container(

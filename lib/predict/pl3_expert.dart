...
import 'package:lottery_app/model/pl3_expert.dart';
import 'package:lottery_app/predict/pl3_predict_detail.dart';
import 'package:lottery_app/predict/pl3_predict_view.dart';
import 'package:provider/provider.dart';

class ExpertPl3Page extends StatefulWidget {
  @override
  ExpertPl3PageState createState() => new ExpertPl3PageState();
}

class ExpertPl3PageState extends State<ExpertPl3Page> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: ChangeNotifierProvider(
        create: (_) => Pl3ExpertModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              NavAppBar(
  ...
  Widget _buildPl3ForecastList() {
    return Consumer<Pl3ExpertModel>(
        builder: (BuildContext context, Pl3ExpertModel model, Widget child) {
      Widget view = null;
      if (model.loaded) {
        if (model.error) {
          view = Column(
  ...
  Widget _buildForecastItem(ForecastBrief brief) {
    return GestureDetector(
      onTap: () {
        AppNavigator.push(context, Pl3PredictDetail(period: brief.period));
      },
      child: Container(
        padding: EdgeInsets.only(
  ...
  @override
  void didUpdateWidget(ExpertPl3Page oldWidget) {

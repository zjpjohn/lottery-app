...
import 'package:lottery_app/model/ssq_expert.dart';
import 'package:lottery_app/predict/ssq_predict_detail.dart';
import 'package:lottery_app/predict/ssq_predict_view.dart';
import 'package:provider/provider.dart';

class ExpertSsqPage extends StatefulWidget {
  @override
  ExpertSsqPageState createState() => new ExpertSsqPageState();
}

class ExpertSsqPageState extends State<ExpertSsqPage> {
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: ChangeNotifierProvider<SsqExpertModel>(
        create: (_) => SsqExpertModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              NavAppBar(
  ...
  Widget _buildSsqForecastList() {
    return Consumer(
        builder: (BuildContext context, SsqExpertModel model, Widget child) {
      Widget view = null;
      if (model.loaded) {
        if (model.error) {
          view = Column(
  ...
  Widget _buildForecastItem(ForecastBrief brief) {
    return GestureDetector(
      onTap: () {
        AppNavigator.push(context, SsqPredictDetail(period: brief.period));
      },
      child: Container(
        padding: EdgeInsets.only(
  ...
  @override
  void didUpdateWidget(ExpertSsqPage oldWidget) {

...
import 'package:lottery_app/model/dlt_predict.dart';
import 'package:provider/provider.dart';

class DltPredictPage extends StatefulWidget {
  String period;

  DltPredictPage({@required this.period});

  @override
  DltPredictPageState createState() => new DltPredictPageState();
}

class DltPredictPageState extends State<DltPredictPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.dark,
      child: ChangeNotifierProvider(
        create: (_) => DltPredictModel(widget.period),
        child: Scaffold(
          body: Consumer(builder:
              (BuildContext context, DltPredictModel model, Widget child) {
            return Column(
              children: <Widget>[
                NavAppBar(
                  title: '大乐透预测',
  ...
  Widget _buildForecastView(DltPredictModel model) {
    return Expanded(
  ...
  Widget _buildRedView(DltPredictModel model) {
    return Offstage(
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      if (model.red.length < 20) {
                        EasyLoading.showToast('请先选20个红球');
                        return;
                      }
                      model.step = 1;
                    },
  ...
  Widget _buildRedBall(DltPredictModel model) {
    List<Widget> views = Constant.DLT_RED.map((v) {
      return BallButton(
        value: v,
        size: 38,
        fontSize: 18,
  ...
  Widget _buildRedKillView(DltPredictModel model) {
    return Offstage(
  ...
  Widget _buildRedKillBall(DltPredictModel model) {
    List<Widget> views = Constant.DLT_RED.map((v) {
      return BallButton(
        value: v,
        size: 38,
  ...
  Widget _buildBlueView(DltPredictModel model) {
    return Offstage(
  ...
  Widget _buildBlueBall(DltPredictModel model) {
    List<Widget> views = Constant.DLT_BLUE.map((v) {
      return BallButton(
        value: v,
        size: 38,
        fontSize: 18,
  ...
  Widget _buildBlueKillView(DltPredictModel model) {
    return Offstage(
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  GestureDetector(
                    onTap: () {
                      if (model.blueKill.length < 3) {
                        EasyLoading.showToast('请先选3个号码');
                        return;
                      }
                      model.step = 4;
                    },
  ...
  Widget _buildBlueKillBall(DltPredictModel model) {
    List<Widget> views = Constant.DLT_BLUE.map((v) {
      return BallButton(
        value: v,
        size: 38,
  ...
  ///
  Widget _buildResultView(DltPredictModel model) {
    return Offstage(
        ...
        child: model.hasData()
            ? Column(
                ...
                children: <Widget>[
                  ...
                  _resultItemView('红球10码', model.redJoin(10)),
                  _resultItemView('红球20码', model.redJoin(20)),
                  _resultItemView('红球杀三码', model.redKillJoin(3)),
                  _resultItemView('红球杀六码', model.redKillJoin(6)),
                  _resultItemView('蓝球一码', model.blueJoin(1),
                      color: Colors.blueAccent),
                  _resultItemView('蓝球二码', model.blueJoin(2),
                      color: Colors.blueAccent),
                  _resultItemView('蓝球六码', model.blueJoin(6),
                      color: Colors.blueAccent),
                  _resultItemView('蓝球杀码', model.blueKillJoin(3),
                      color: Colors.blueAccent),
                  Container(
                    alignment: Alignment.center,
  ...
  @override
  void didUpdateWidget(DltPredictPage oldWidget) {

...
import 'package:lottery_app/bigshot/fc3d_bigshot.dart';
...
import 'package:lottery_app/glad/fc3d-glad.dart';
import 'package:lottery_app/master/fc3d-master.dart';
import 'package:lottery_app/model/fc3d_lottery.dart';
import 'package:lottery_app/overall/fc3d_overall.dart';
import 'package:lottery_app/picker/fc3d-picker.dart';
import 'package:lottery_app/compare/fc3d-compare.dart';
import 'package:lottery_app/rank/fc3d-ranks.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/commons/custome_card.dart';
import 'package:lottery_app/commons/app_navigator.dart';
import 'package:lottery_app/commons/tools.dart';
import 'package:lottery_app/comprehensive/fc3d_chart.dart';

class Fc3dLotteryPage extends StatefulWidget {
  Fc3dLotteryModel model;

  Fc3dLotteryPage(this.model);

  @override
  Fc3dLotteryPageState createState() => new Fc3dLotteryPageState();
}

class Fc3dLotteryPageState extends State<Fc3dLotteryPage>
  ...
  Widget _gladHeader() {
    return Container(
      ...
      child: InkWell(
        onTap: () {
          AppNavigator.push(context, Fc3dGladPage());
        },
        child: new Container(
          alignment: Alignment.center,
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                AppNavigator.push(context, Fc3dRanksPage());
                              },
                              child: Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          VipNavButton(
            ...
            onTap: () {
              AppNavigator.push(context, Fc3dComparePage(), login: true);
            },
          ),
          VipNavButton(
            name: '综合分析',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, Fc3dComprehensivePage(), login: true);
            },
          ),
          VipNavButton(
            name: '热门精选',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, Fc3dPickerPage(), login: true);
            },
          ),
          VipNavButton(
            name: '臻选牛人',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, Fc3dBigshotPage(), login: true);
            },
          ),
          VipNavButton(
            name: '整体态势',
            ...
            onTap: () {
              AppNavigator.push(context, Fc3dOverallPage(), login: true);
            },
          ),
        ],
      ),

...
import 'package:lottery_app/bigshot/dlt_bigshot.dart';
...
import 'package:lottery_app/glad/dlt-glad.dart';
import 'package:lottery_app/master/dlt-master.dart';
import 'package:lottery_app/model/dlt_lottery.dart';
import 'package:lottery_app/overall/dlt_overall.dart';
import 'package:lottery_app/picker/dlt-picker.dart';
import 'package:lottery_app/compare/dlt-compare.dart';
import 'package:lottery_app/rank/dlt-ranks.dart';
import 'package:lottery_app/commons/constants.dart';
import 'package:lottery_app/commons/custome_card.dart';
import 'package:lottery_app/commons/app_navigator.dart';
import 'package:lottery_app/commons/tools.dart';
import 'package:lottery_app/comprehensive/dlt_chart.dart';

class DltLotteryPage extends StatefulWidget {
  DltLotteryModel model;

  DltLotteryPage(this.model);

  @override
  DltLotteryPageState createState() => new DltLotteryPageState();
}

class DltLotteryPageState extends State<DltLotteryPage>
  ...
  Widget _gladHeader() {
    return Container(
      ...
      child: new InkWell(
        onTap: () {
          AppNavigator.push(context, DltGladPage());
        },
        child: new Container(
          alignment: Alignment.center,
          padding: EdgeInsets.only(
                      ...
                      children: <Widget>[
                        ...
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                AppNavigator.push(context, DltRanksPage(type));
                              },
                              child: Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          VipNavButton(
            ...
            onTap: () {
              AppNavigator.push(context, DltComparePage(), login: true);
            },
          ),
          VipNavButton(
            name: '综合分析',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, DltComprehensivePage(), login: true);
            },
          ),
          VipNavButton(
            name: '热门精选',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, DltPickerPage(), login: true);
            },
          ),
          VipNavButton(
            name: '臻选牛人',
            ...
            margin: EdgeInsets.fromLTRB(
                0, Adaptor.width(12), Adaptor.width(12), Adaptor.width(6)),
            onTap: () {
              AppNavigator.push(context, DltBigshotPage(), login: true);
            },
          ),
          VipNavButton(
            name: '整体态势',
            ...
            onTap: () {
              AppNavigator.push(context, DltOverallPage(), login: true);
            },
          ),
        ],
      ),

...
class _ChangeAnimation extends Animation<double>
  ...
  @override
  double get value {
    return _indexChangeProgress(controller);
  }
}
...
class _DragAnimation extends Animation<double>
  ...
  double get value {
    ...
    double value =
        (controller.animation.value - index.toDouble()).abs().clamp(0.0, 1.0) >
                0.5
            ? 1.0
            : 0.0;
    return value;
...
class _TabBarState extends State<CTabBar> {
  ...
  void _handleTap(int index) {
    ...
    _controller.animateTo(index, duration: Duration(milliseconds: 150));

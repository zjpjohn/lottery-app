...
class _WaveWidgetState extends State<WaveWidget> with TickerProviderStateMixin {
  ...
  _initWave() {
    if (widget.config.colorMode == ColorMode.custom) {
      _wavePhaseValues = (widget.config as CustomConfig).heightPercentages.map((value) {
        _waveAmplitudes.add(widget.waveAmplitude + 10);
        return widget.wavePhase+Random().nextInt(360);
      }).toList();
    }
  }

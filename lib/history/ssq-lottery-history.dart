...
class SsqLotteryHistory extends StatefulWidget {
  @override
  SsqLotteryHistoryState createState() => new SsqLotteryHistoryState();
}

class SsqLotteryHistoryState extends State<SsqLotteryHistory> {
  //开奖数据

...
class Fc3dLotteryHistory extends StatefulWidget {
  @override
  Fc3dLotteryHistoryState createState() => new Fc3dLotteryHistoryState();
}

class Fc3dLotteryHistoryState extends State<Fc3dLotteryHistory> {
  //开奖数据
  List _lotteries = List();
                  ...
                  children: <Widget>[
                    Expanded(
                      child: new Container(
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: _ballView(item['redBalls'], null),
                        ),
                      ),
                      flex: 1,
                    ),
                    Expanded(
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.start,
                        children: _shiViews(item['shiBalls']),
                      ),
                      flex: 1,
                    )
                  ],
  ...
  List<Widget> _shiViews(var shis) {

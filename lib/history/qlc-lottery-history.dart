...
class QlcLotteryHistory extends StatefulWidget {
  @override
  QlcLotteryHistoryState createState() => new QlcLotteryHistoryState();
}

class QlcLotteryHistoryState extends State<QlcLotteryHistory> {
  //开奖数据

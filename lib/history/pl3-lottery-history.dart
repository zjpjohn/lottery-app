...
class Pl3LotteryHistory extends StatefulWidget {
  @override
  Pl3LotteryHistoryState createState() => new Pl3LotteryHistoryState();
}

class Pl3LotteryHistoryState extends State<Pl3LotteryHistory> {
  //开奖数据

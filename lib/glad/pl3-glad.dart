...
class Pl3GladPage extends StatefulWidget {
  @override
  Pl3GladPageState createState() => new Pl3GladPageState();
}

class Pl3GladPageState extends State<Pl3GladPage> {
  //开奖数据
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/pl3/glad', params: params).then((response) {

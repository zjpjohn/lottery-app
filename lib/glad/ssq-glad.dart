...
class SsqGladPage extends StatefulWidget {
  @override
  SsqGladPageState createState() => new SsqGladPageState();
}

class SsqGladPageState extends State<SsqGladPage> {
  //开奖数据
  ...
  Widget _itemView(BuildContext context, int index) {
    return _gladView(this._glads[index]);
  }
            ...
            child: Row(
              children: <Widget>[
                Container(
                  ...
                  margin: EdgeInsets.fromLTRB(
                      Adaptor.width(14), 0, Adaptor.width(14), 0),
                  alignment: Alignment.center,
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/ssq/glad', params: params).then((response) {

...
class Fc3dGladPage extends StatefulWidget {
  @override
  Fc3dGladPageState createState() => new Fc3dGladPageState();
}

class Fc3dGladPageState extends State<Fc3dGladPage> {
  //开奖数据
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/fc3d/glad', params: params).then((response) {

...
class QlcGladPage extends StatefulWidget {
  @override
  QlcGladPageState createState() => new QlcGladPageState();
}

class QlcGladPageState extends State<QlcGladPage> {
  //开奖数据
  ...
  void _loadData() {
    ...
    params['page'] = _page;
    params['limit'] = _limit;
    request.getJson('/qlc/glad', params: params).then((response) {

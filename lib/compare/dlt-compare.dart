...
import 'package:lottery_app/model/dlt_compare.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class DltComparePage extends StatefulWidget {
  @override
  DltComparePageState createState() => new DltComparePageState();
}

class DltComparePageState extends State<DltComparePage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => DltCompareModel.initialize(),
        child: Scaffold(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, DltCompareModel model, Widget child) {
      return Container(
  ...
  Widget _buildLevelTab(DltCompareModel model) {
    return Container(
  ...
  Widget _buildGridTab(DltCompareModel model) {
    return Padding(
  ...
  Widget _itemView(DltCompareModel model, var data, double top) {
    return Container(

...
import 'package:lottery_app/model/ssq_compare.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class SsqComparePage extends StatefulWidget {
  @override
  SsqComparePageState createState() => new SsqComparePageState();
}

class SsqComparePageState extends State<SsqComparePage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => SsqCompareModel.initialize(),
        child: Scaffold(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, SsqCompareModel model, Widget child) {
      return Container(
  ...
  Widget _buildLevelTab(SsqCompareModel model) {
    return Container(
  ...
  Widget _buildGridTab(SsqCompareModel model) {
    return Padding(
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: model.selectedIndex == index ? Colors.white : Colors.black26,
                  ),
                ),
              )
            ],
  ...
  Widget _buildLevel(
    ...
    TextStyle style = new TextStyle(color: Colors.black54, fontSize: 14);
    if (model.level == index) {
      style = new TextStyle(color: Color(0xffF43F3B), fontSize: 14);
    }
    return Container(
      alignment: Alignment.center,
      margin: EdgeInsets.fromLTRB(margin, 0, 16, 0),
      child: GestureDetector(
        onTap: () {
          model.level = index;
        },
  ...
  Widget _itemView(SsqCompareModel model, var data, double top) {
    return Container(
              ...
              children: <Widget>[
                Expanded(
                  child: Text(
                    ...
                    style: TextStyle(
                        color: Color(0xff5c5c5c), fontSize: Adaptor.sp(12)),
                  ),
                  flex: 2,
                ),
                Expanded(

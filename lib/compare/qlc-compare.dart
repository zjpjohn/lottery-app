...
import 'package:lottery_app/model/qlc_compare.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class QlcComparePage extends StatefulWidget {
  @override
  QlcComparePageState createState() => new QlcComparePageState();
}

class QlcComparePageState extends State<QlcComparePage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => QlcCompareModel.initialize(),
        child: Scaffold(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, QlcCompareModel model, Widget child) {
      return Container(
  ...
  Widget _buildGridTab(QlcCompareModel model) {
    return Padding(
  ...
  Widget _buildLevelTab(QlcCompareModel model) {
    return Container(
      height: 26,
  ...
  Widget _itemView(QlcCompareModel model, var data, double top) {
    return Container(

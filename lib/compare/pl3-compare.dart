...
import 'package:lottery_app/model/pl3_compare.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class Pl3ComparePage extends StatefulWidget {
  @override
  Pl3ComparePageState createState() => new Pl3ComparePageState();
}

class Pl3ComparePageState extends State<Pl3ComparePage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => Pl3CompareModel.initialize(),
        child: Scaffold(
  ...
  Widget _buildList() {
    return Consumer(
        builder: (BuildContext context, Pl3CompareModel model, Widget child) {
      return Container(
  ...
  Widget _buildGridTab(Pl3CompareModel model) {
    return Padding(
  ...
  Widget _buildLevelTab(Pl3CompareModel model) {
    return Container(
  ...
  Widget _itemView(Pl3CompareModel model, var data, double top) {

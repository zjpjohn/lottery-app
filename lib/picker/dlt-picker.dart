...
import 'package:lottery_app/model/dlt_picker.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class DltPickerPage extends StatefulWidget {
  @override
  DltPickerPageState createState() => new DltPickerPageState();
}
...
class DltPickerPageState extends State<DltPickerPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => DltPickerModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('热门精选'),
  ...
  Widget _buildGridTab() {
    return Consumer(
        builder: (BuildContext context, DltPickerModel model, Widget child) {
      return Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                model.period != null ? '第${model.period}期大乐透热门统计' : '',
                style: TextStyle(

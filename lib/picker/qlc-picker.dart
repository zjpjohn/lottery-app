...
import 'package:lottery_app/model/qlc_picker.dart';
import 'package:lottery_app/package/vip-package.dart';
import 'package:provider/provider.dart';

class QlcPickerPage extends StatefulWidget {
  @override
  QlcPickerPageState createState() => new QlcPickerPageState();
}
...
class QlcPickerPageState extends State<QlcPickerPage> {
  @override
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      value: SystemUiOverlayStyle.light,
      child: ChangeNotifierProvider(
        create: (_) => QlcPickerModel.initialize(),
        child: Scaffold(
          body: Column(
            children: <Widget>[
              MAppBar('热门精选'),
  ...
  Widget _buildGridTab() {
    return Consumer(
        builder: (BuildContext context, QlcPickerModel model, Widget child) {
      return Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                model.period != null ? '第${model.period}期七乐彩热门统计' : '',
                style: TextStyle(

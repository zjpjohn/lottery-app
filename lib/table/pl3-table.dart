...
class Pl3TablePage extends StatefulWidget {
  @override
  Pl3TablePageState createState() => new Pl3TablePageState();
}

class Pl3TablePageState extends State<Pl3TablePage> {
  //是否加载
  bool _loaded = false;
            ...
            child: Row(
              ...
              children: <Widget>[
                _buildBall(
                  ...
                  _lastShi,
                  Color(0xffb0c8a5),
                  size: _lastShi == null || _lastShi.isEmpty ? 11 : 12,
                ),
                _buildBall(
                  '开奖号',
                  _last,
